class ProductPage():
    ...
    def __init__(self, driver):
        ...
        self.fixed_price_field_textbox_id = "custom_price_01"
    ...
    def product_price(self, price_value):
        ...
        self.price_value_float = float(price_value)
        self.total_price_calculated = 20 + self.price_value_float
        self.product_price_label = self.driver.find_element_by_css_selector('div.summary').find_element_by_css_selector(
            'p.price')
        ...
        self.extra_price_display = self.driver.find_element_by_css_selector(
        self.extra_price_display_label_css_selector).find_element_by_class_name(
        self.extra_price_display_label_span_class).find_element_by_class_name(
        self.extra_price_display_label_element_class)
        ...
        if self.extra_price_display_remove_suffix_float == self.price_value_float:
        ...
        self.total_price_display = self.driver.find_element_by_css_selector(
        self.extra_price_display_label_css_selector).find_element_by_class_name(
        self.total_price_display_label_span_class).find_element_by_class_name(
        self.extra_price_display_label_element_class)
