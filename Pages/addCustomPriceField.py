...
class AddCustomPriceField():
    ...
    def create_custom_price_field(self, field_name, field_title):
        ...
        self.select_price_type_value = Select(self.driver.find_element_by_xpath(self.price_type_select_xpath))
        self.select_price_type_value.select_by_value("custom")
